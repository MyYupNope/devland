...
void main() {
    ...
    vColor = mix(customColor, heatMap, heat);
    vCoverage = aCoverage;
    vSourceUV = aSourceUV;
    ...
    float sizeBase = mix(uPointSize, uPointSize * aRandomSize, 0.25);
    gl_PointSize = sizeBase * uPixelRatio * uPointScale * (1.0 + heat * 0.4);
}
`;
